...
namespace dataCollector.dataHandler{
    public class UpdateData{
        ...
        public UpdateData(ref ComputerInfo computerInfo, ref NetworkInfo networkInfo, ref UpsInfo upsInfo, ref MonitorInfo monitorInfo, ref UiDataModel uiDataModel, ref UiDataModel.UiPcDataModel pcDataModel, ref UiDataModel.UiUpsDataModel upsDataModel){
